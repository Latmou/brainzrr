...
export type ReleaseWhereInput = {
  ...
  mbid?: Prisma.StringFilter<"Release"> | string
  title?: Prisma.StringFilter<"Release"> | string
  artist?: Prisma.StringFilter<"Release"> | string
  coverArtUrl?: Prisma.StringNullableFilter<"Release"> | string | null
  data?: Prisma.JsonFilter<"Release">
  addedAt?: Prisma.DateTimeFilter<"Release"> | Date | string
...
export type ReleaseScalarWhereWithAggregatesInput = {
  ...
  mbid?: Prisma.StringWithAggregatesFilter<"Release"> | string
  title?: Prisma.StringWithAggregatesFilter<"Release"> | string
  artist?: Prisma.StringWithAggregatesFilter<"Release"> | string
  coverArtUrl?: Prisma.StringNullableWithAggregatesFilter<"Release"> | string | null
  data?: Prisma.JsonWithAggregatesFilter<"Release">
  addedAt?: Prisma.DateTimeWithAggregatesFilter<"Release"> | Date | string
...
export type ReleaseOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"mbid" | "title" | "artist" | "coverArtUrl" | "data" | "addedAt" | "updatedAt", ExtArgs["result"]["release"]>
...
export interface ReleaseDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const releaseWithMbidOnly = await prisma.release.findMany({ select: { mbid: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Releases and only return the `mbid`
   * const releaseWithMbidOnly = await prisma.release.createManyAndReturn({
   *   select: { mbid: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Releases and only return the `mbid`
   * const releaseWithMbidOnly = await prisma.release.updateManyAndReturn({
   *   select: { mbid: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ReleaseFieldRefs {
  readonly mbid: Prisma.FieldRef<"Release", 'String'>
  readonly title: Prisma.FieldRef<"Release", 'String'>
  readonly artist: Prisma.FieldRef<"Release", 'String'>
  readonly coverArtUrl: Prisma.FieldRef<"Release", 'String'>
  readonly data: Prisma.FieldRef<"Release", 'Json'>
  readonly addedAt: Prisma.FieldRef<"Release", 'DateTime'>
